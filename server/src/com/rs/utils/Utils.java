...
public final class Utils {
	...
	public static String[] INVALID_TITLES = { 
		"0wner", "owner", "own3r", "0wn3r"
	};
	
	public static boolean titleHasInvalidChars(String title) {
		for (String n : INVALID_CHARS) {
			if (title.contains(n))
				return true;
		}
		return false;
	...
	/**
	 * @param hex
	 * @return true if the string contains only 0-9 and letters A-F
	 */
	 ...
	 * @return BigInteger as a string, with commas
	 */
	...
	public static String getTimeRemaining(long time) {
		...
		return ""+hours+"hrs. "+min+"min. "+sec+"sec.";
	}
	
	/**
	 * @param name or word
	 * @return true if it starts with a vowel
	 */
	...
	/**
	 * @return the amount of time the server has been online.
	 */
