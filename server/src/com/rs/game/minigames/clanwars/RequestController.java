...
public final class RequestController extends Controler {
	...
	public boolean processButtonClick(int interfaceId, int componentId,
		...
		ClanWars clanWars = (ClanWars) player.getAttributes().get(
				"clan_wars");
		if (clanWars == null) {
			return true;
		}
		Player other = (Player) player.getAttributes().get(
				"clan_request_p");
		if (other == null
				|| player.getAttributes().get("clan_wars") != other
						.getAttributes().get("clan_wars")) {
			return true;
		}
		switch (interfaceId) {
		case 791:
			...
			case 40:
				...
				return false;
			case 43:
				clanWars.setVictoryType(1000, player, other);
				return false;
			case 46:
				clanWars.setVictoryType(2500, player, other);
				return false;
			case 49:
				clanWars.setVictoryType(5000, player, other);
				return false;
			case 52:
				clanWars.setVictoryType(10000, player, other);
				return false;
			case 56: // Most kills.
			...
			case 60:
				...
				return false;
			case 63:
				clanWars.setTimeLeft(1000, player, other);
				return false;
			case 66:
				clanWars.setTimeLeft(3000, player, other);
				return false;
			case 69:
				clanWars.setTimeLeft(6000, player, other);
				return false;
			case 72:
				clanWars.setTimeLeft(9000, player, other);
				return false;
			case 75:
				clanWars.setTimeLeft(12000, player, other);
				return false;
			case 78:
				clanWars.setTimeLeft(15000, player, other);
				return false;
			case 81:
				clanWars.setTimeLeft(18000, player, other);
				return false;
			case 84:
				clanWars.setTimeLeft(24000, player, other);
				return false;
			case 87:
				clanWars.setTimeLeft(30000, player, other);
				return false;
			case 90:
				clanWars.setTimeLeft(36000, player, other);
				return false;
			case 93:
				clanWars.setTimeLeft(48000, player, other);
				return false;
			case 100:
	...
	public boolean canPlayerOption1(final Player target) {
		...
		player.setCoordsEvent(new CoordsEvent(target, new Runnable() {
			...
			public void run() {
				...
				player.getAttributes().put("clan_request_p", target);
				if (target.getAttributes().get("clan_request_p") == player) {
	...
	public void decline() {
		Player other = (Player) player.getAttributes().get(
				"clan_request_p");
		ClanWars war = (ClanWars) player.getAttributes().get(
				"clan_wars");
		...
		if (war != null) {
			...
			player.getAttributes().remove("clan_request_p");
			other.getAttributes().remove("clan_request_p");
			player.getAttributes().remove("clan_wars");
			other.getAttributes().remove("clan_wars");
		}
	}
