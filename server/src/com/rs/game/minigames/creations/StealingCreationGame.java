...
public class StealingCreationGame extends Controler {
	...
	private void processKilnExchange(int componentId, int packetId) {
		...
		if (packetId == WorldPacketsDecoder.ACTION_BUTTON1_PACKET)
			...
			player.getAttributes().put("scIndex", index);
			player.getAttributes().put("scComponentId", componentId);
			player.getAttributes().put("scItemId", itemId);
			player.getAttributes().put("scAmount", amount);
			player.getAttributes().put("kilnX", true);
