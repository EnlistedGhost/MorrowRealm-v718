...
public final class PlayerLook {
	...
	public static void handleMageMakeOverButtons(Player player, int buttonId) {
		if (buttonId == 14 || buttonId == 16 || buttonId == 15
				|| buttonId == 17)
			player.getAttributes().put("MageMakeOverGender",
			...
			Boolean male = (Boolean) player.getAttributes().remove(
					"MageMakeOverGender");
			Integer skin = (Integer) player.getAttributes().remove(
					"MageMakeOverSkin");
	...
	public static void handleHairdresserSalonButtons(Player player,
		...
		if (buttonId == 6)
			...
			Boolean hairSalon = (Boolean) player.getAttributes().get(
					"hairSaloon");
	...
	public static void handleThessaliasMakeOverButtons(Player player,
		...
		if (buttonId == 6)
			...
			Integer stage = (Integer) player.getAttributes().get(
					"ThessaliasMakeOver");
	...
	public static void openHairdresserSalon(final Player player) {
		...
		player.setCloseInterfacesEvent(new Runnable() {
			...
			public void run() {
				...
				player.setNextAnimation(new Animation(-1));
				player.getAppearence().getAppeareanceData();
				player.getAttributes().remove("hairSaloon");
			}
