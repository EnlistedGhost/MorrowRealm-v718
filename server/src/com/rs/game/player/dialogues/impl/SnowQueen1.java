...
public class SnowQueen1 extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
				...
				break;
		case 1:
			sendNPCDialogue(npcId, 9827, "Santa! Santa has been kidnapped!");
			stage = 2;
			break;
		case 2:
		...
		case 3:
			...
			break;
		case 4:
			sendPlayerDialogue(9827, "Well I can help find Santa Your Majesty");
			stage = 5;
			break;
		case 5:
			sendNPCDialogue(npcId, 9827, "Oh my, thank you so much "+ player.getDisplayName() +".",
					"");
			stage = 111;
			player.christmas = 1;
			break;
