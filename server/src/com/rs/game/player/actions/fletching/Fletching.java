...
public class Fletching extends Action {
	...
	public static enum Fletch {
		...
		BLOODWOOD(24121, 946, new int[] { 24122 }, new int[] { 93 }, new double[] { 13.0 }, new Animation(6702)),
		...
		OPAL_BOLTS(45, 877, new int[] { /* 879 */9236 }, new int[] { 11 }, new double[] { 1.6 }, new Animation(-1)),
		
		BLURITE_BOLTS(9376, 314, new int[] { 9139 }, new int[] { 24 }, new double[] { 1 }, new Animation(-1)),

		JADE_BOLTS(9187, 9376, new int[] { /* 9335 */9237 }, new int[] { 26 }, new double[] { 2.4 }, new Animation(-1)),

		PEARL_BOLTS(46, 9140, new int[] { /* 880 */9238 }, new int[] { 41 }, new double[] { 3.2 }, new Animation(-1)),

		SILVER_BOLTS(9382, 314, new int[] { 9145 }, new int[] { 43 }, new double[] { 2.5 }, new Animation(-1)),

		RED_TOPAZ_BOLTS(9188, 9141, new int[] { /* 9336 */9239 }, new int[] { 48 }, new double[] { 3.9 },
				new Animation(-1)),
		...
		SAPPHIRE_BOLTS(9189, 9142, new int[] { /* 9337 */9240 }, new int[] { 56 }, new double[] { 2.4 },
				new Animation(-1)),

		EMERALD_BOLTS(9190, 9142, new int[] { /* 9335 */9241 }, new int[] { 26 }, new double[] { 4.7 },
				new Animation(-1)),

		RUBY_BOLTS(9191, 9143, new int[] { /* 9339 */9242 }, new int[] { 63 }, new double[] { 6.3 }, new Animation(-1)),

		DIAMOND_BOLTS(9192, 9143, new int[] { /* 9340 */9243 }, new int[] { 65 }, new double[] { 7 },
				new Animation(-1)),

		DRAGON_BOLTS(9193, 9144, new int[] { /* 9341 */9244 }, new int[] { 71 }, new double[] { 8.2 },
				new Animation(-1)),

		ONYX_BOLTS(9194, 9144, new int[] { /* 9342 */9245 }, new int[] { 73 }, new double[] { 9.4 }, new Animation(-1)),
