...
public class Fishing extends Action {
	...
	private void addFish(Player player) {
		...
		player.getGoals().increase(Skills.FISHING);
	...
	private boolean checkAll(Player player) {
		...
		if (!player.getTools().contains(spot.getTool())) {
		...
		if (!player.getTools().contains(spot.getTool()) && !player.getInventory().containsOneItem(spot.getTool())) {
