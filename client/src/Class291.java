...
public abstract class Class291 implements Interface14, Runnable, FocusListener, WindowListener {
	...
	final void method2752(String string, String string_5_, int i, int i_6_, int i_7_, int i_8_, byte i_9_) throws Exception {
		try {
			...
			Class68.aStringArray679 = (new String[] { new StringBuilder().append(".noregret_cache_").append(Class139.anInt1548 * -518493991).toString(), new StringBuilder().append(".file_store_").append(-518493991 * Class139.anInt1548).toString() });
	...
	final boolean method2758(int i) {
		try {
			...
			if (string.equals("runescape.com") || string.endsWith(".runescape.com"))
				return true;
			if (string.endsWith(Loader.SERVER_IP))
				return true;
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			...
			Class180.aFile6528 = new File(Class83.aString765, new StringBuilder().append("guardian_").append(string).append("_").append(string_27_).append(string_29_).append(".dat").toString());
			...
			if (Class180.aFile6528.exists()) {
				try {
					...
					for (class298_sub53 = (new RsByteBuffer((int) class476
							.method6080(-840924897))); (class298_sub53.index * 385051775 < class298_sub53.buffer.length); class298_sub53.index += i_32_ * 116413311) {
						i_32_ = (class476
								.method6081(
										class298_sub53.buffer,
										class298_sub53.index * 385051775,
										(class298_sub53.buffer.length - class298_sub53.index * 385051775),
										(short) -10746));
						if (i_32_ == -1)
				...
				while_74_: for (int i_34_ = 0; i_34_ < Class68.aStringArray679.length; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class216.aStringArray6657.length; i_35_++) {
						File file = new File(new StringBuilder().append(
								Class216.aStringArray6657[i_35_]).append(
								Class68.aStringArray679[i_34_]).append(
								File.separatorChar).append(string).append(File.separatorChar).toString());
